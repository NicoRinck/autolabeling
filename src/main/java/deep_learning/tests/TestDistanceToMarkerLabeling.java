...
public class TestDistanceToMarkerLabeling {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Input Data
        File trainDirectory = new File("C:\\Users\\Nico Rinck\\Documents\\DHBW\\Studienarbeit\\Daten_Studienarbeit\\trainDistance");
        File testDirectory = new File("C:\\Users\\Nico Rinck\\Documents\\DHBW\\Studienarbeit\\Daten_Studienarbeit\\testDistance");
        ...
        System.out.println(trainDataReader.next().size());
        ...
        MultiLayerConfiguration multiLayerConfiguration = new NeuralNetConfiguration.Builder()
                ...
                .layer(new OutputLayer.Builder(LossFunctions.LossFunction.MSE).nIn(17).nOut(2).activation(Activation.SIGMOID).weightInit(WeightInit.SIGMOID_UNIFORM).build())
                .build();
